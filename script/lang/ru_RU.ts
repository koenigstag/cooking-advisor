export const LANG_RU_RU = {
  ...
  tabError: {
    title: 'Не удалось отобразить этот раздел',
    hint: 'Что-то пошло не так при отрисовке вкладки. Попробуйте переключить вкладку или перезагрузить страницу.',
  },
  cardError: {
    message: 'Не удалось отобразить этот элемент.',
  },
